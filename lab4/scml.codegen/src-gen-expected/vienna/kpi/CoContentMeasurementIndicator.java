...
public class CoContentMeasurementIndicator extends Indicator {
	private List<String> lastCalculations;
	
	
	public CoContentMeasurementIndicator(){
		super("CoContentMeasurementIndicator");
		status = "GOOD";
		lastCalculations = new ArrayList<String>();
	}
	
	public void setParameter(GECo2Content aggregator){
