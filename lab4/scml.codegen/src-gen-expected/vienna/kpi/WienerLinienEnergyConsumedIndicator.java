...
public class WienerLinienEnergyConsumedIndicator extends Indicator {
	private List<String> lastCalculations;
	
	
	public WienerLinienEnergyConsumedIndicator(){
		super("WienerLinienEnergyConsumedIndicator");
		status = "GOOD";
		lastCalculations = new ArrayList<String>();
	}
	
	public void setParameter(STenergyConsumedWienerLinien aggregator){
