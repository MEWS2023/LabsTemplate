...
public class STWienerLinien extends Producer {

	private DataValueStack stack;
	
	public STenergyConsumedWienerLinien parameter;
	
	
	public STWienerLinien(String name, DataSource<String> dataSource) {
		super(name, dataSource);
		parameter = new STenergyConsumedWienerLinien(this);
...
public void printTransportationComponentSTWienerLinienInfo(){
	System.out.println("🚂 Transportation Component ==> " + "ST Wiener Linien");
