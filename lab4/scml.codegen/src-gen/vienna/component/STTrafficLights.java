...
import vienna.parameter.STcarsPerMinute;


public class STTrafficLights extends Producer {

	private DataValueStack stack;
	
	public STcarsPerMinute parameter;
	
	
	public STTrafficLights(String name, DataSource<String> dataSource) {
		super(name, dataSource);
		parameter = new STcarsPerMinute(this);
...
public void printEnvironmentalComponentSTTrafficLightsInfo(){
	System.out.println("🌳 Name ==> " + "ST Traffic Lights");
