...
public class KPIMeasurementDeviceImpl extends NamedElementImpl implements KPIMeasurementDevice {
	...
	public NotificationChain basicSetParameter(Parameter newParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ScmlPackage.KPI_MEASUREMENT_DEVICE__PARAMETER, oldParameter, newParameter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setParameter(Parameter newParameter) {
		if (newParameter != parameter) {
			...
			if (parameter != null)
				msgs = ((InternalEObject) parameter).eInverseRemove(this, ScmlPackage.PARAMETER__KPIMEASUREMENTDEVICE,
						Parameter.class, msgs);
			if (newParameter != null)
				msgs = ((InternalEObject) newParameter).eInverseAdd(this, ScmlPackage.PARAMETER__KPIMEASUREMENTDEVICE,
						Parameter.class, msgs);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						try {
							final /*@NonInvalid*/ AggregatedValue observedValue = parameter_1.getObservedValue();
							final /*@NonInvalid*/ boolean ne = observedValue != null;
							...
							if (and == ValueUtil.FALSE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ DataType type = observedValue.getType();
						...
						if (CAUGHT_and_0 == ValueUtil.FALSE_VALUE) {
							...
							final /*@NonInvalid*/ GoalReferenceValue goalreferencevalue = parameter_1
									.getGoalreferencevalue();
							final /*@NonInvalid*/ DataType type_0 = goalreferencevalue.getType();
							final /*@NonInvalid*/ EnumerationLiteralId BOXED_type_0 = ScmlTables.ENUMid_DataType
									.getEnumerationLiteralId(ClassUtil.nonNullState(type_0.getName()));
							final /*@NonInvalid*/ boolean eq_1 = BOXED_type_0 == ScmlTables.ELITid_INTEGER;
							if (!eq_1) {
								and_1 = ValueUtil.FALSE_VALUE;
							} else {
					...
					if (CAUGHT_and_1 == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ AggregatedValue observedValue_1 = parameter_3.getObservedValue();
							...
							final /*@NonInvalid*/ GoalReferenceValue goalreferencevalue_0 = parameter_3
									.getGoalreferencevalue();
							final /*@NonInvalid*/ String value_0 = goalreferencevalue_0.getValue();
							final /*@NonInvalid*/ IntegerValue toInteger_0 = StringToIntegerOperation.INSTANCE
									.evaluate(value_0);
							if (toInteger_0 == null) {
								throw new InvalidValueException(
						...
						try {
							...
							if (CAUGHT_ge == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ AggregatedValue observedValue_2 = parameter_5
											.getObservedValue();
									...
									final /*@NonInvalid*/ GoalReferenceValue goalreferencevalue_1 = parameter_5
											.getGoalreferencevalue();
									final /*@NonInvalid*/ String value_2 = goalreferencevalue_1.getValue();
									final /*@NonInvalid*/ IntegerValue toInteger_2 = StringToIntegerOperation.INSTANCE
											.evaluate(value_2);
									if (toInteger_2 == null) {
										throw new InvalidValueException(
												"Null \'\'Real\'\' rather than \'\'OclVoid\'\' value required");
